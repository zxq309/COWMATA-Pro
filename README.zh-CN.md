...
[下载 3.8](https://github.com/zxq309/COWMATA-Pro/releases/tag/v3.8.0) · [实测图文教程](https://zxq309.github.io/COWMATA-Pro/operator-guide-380.html) · [English](README.md) · [项目简介](docs/project/overview.md)
...
| 4 | 数据集构建 | 原始 Raw 与 Label 配对；行为、产犊、发情、怀孕、疫病五类时间戳版本 |
...
自动候选需要人工核对。复核修改原标签及时间范围，不新增重复事件；导出新数据集版本时保留原版本。历史“采食”记录保留，不占用新增快捷键。

## 下载安装

- **安装包**：运行 `COWMATA-Pro-3.8.0-Setup.exe`，选择位置，完成后打开桌面的 **COWMATA Pro™** 快捷方式。
- **便携包**：解压整个 ZIP，在 `COWMATA-Pro-3.8.0-Portable` 文件夹中运行 `COWMATA.exe`。
