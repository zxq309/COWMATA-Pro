...
def main():
    ...
    for name in ("release-360.md", "edge-download.md", "daily-project-guide.html", "daily-project-guide-351.html", "release-352.md", "release-353.md", "daily-project-guide-352.html", "quick-start-illustrated.pdf", "quick-start-illustrated.md", "quick-start-illustrated.source.json", "legacy-dataset-workflow.md", "release-351.md",
    ...
    (destination / "package-manifest.json").write_text(json.dumps({"version": "3.6.0", "files": inventory}, indent=2), encoding="utf-8")
